...
(function () {
  // Проверка, что скрипт запускается только на localhost или develop
  if (
    window.location.hostname === "localhost" ||
    window.location.hostname.includes("develop")
  ) {
    // основной код скрипта сюда
    ...
    console.log("viewport-overlay: разрешён запуск на этом хосте");
  } else {
    console.warn("viewport-overlay: запуск запрещён на этом хосте!");
  }
})();
